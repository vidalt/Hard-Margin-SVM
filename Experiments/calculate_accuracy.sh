...
do
    ...
    do
        ...
        do
            ../Program/test_accuracy ${instance} ../Datasets/Brooks_SVM_Data/n1e+05d2test >> ${algorithm}_Brooks_SVM_Data_d2.csv
        done
    done
    echo "1 - done"
    instances_base=(
    ...
    do
        ...
        for instance in "${array_instances[@]}"
        do
            ../Program/test_accuracy ${instance} ../Datasets/Brooks_SVM_Data/n1e+05d5test >> ${algorithm}_Brooks_SVM_Data_d5.csv
        done
    done
    echo "2 - done"
    instances_base=(
    ...
    do
        ...
        for instance in "${array_instances[@]}"
        do
            ../Program/test_accuracy ${instance} ../Datasets/Brooks_SVM_Data/n1e+05d10test >> ${algorithm}_Brooks_SVM_Data_d10.csv
        done
    done
    echo "3 - done"
